...
export const projects: Project[] = [
  ...
  },
  {
    ...
    shipped: 'April 2026',
    role: 'Solo build',
    blurb: 'Light becomes sound. ESP32 to a Python relay to a WebGL and Web Audio client.',
    standfirst: 'A small system that translates light into sound.',
    body: 'An ESP32 reads light through a photosensor and streams the values over serial. A Python service relays the stream to a React client, where React Three Fiber renders the signal as a live WebGL scene while the Web Audio API renders it sonically. The same signal, expressed two ways. A ground-up rewrite of Sunspot.',
    stackLine: ['ESP32', 'Python', 'React', 'WebGL'],
    stack: ['ESP32', 'Python', 'React', 'TypeScript', 'React Three Fiber', 'Web Audio API'],
    categories: ['product'],
    accent: 'grape',
    links: { source: 'https://github.com/GRIM4CE/photoesthesia' },
  },
  {
    id: 'web-synth-wizard',
